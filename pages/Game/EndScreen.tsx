...
export default function EndScreen() {
  ...
  const endGameConditionDesc = (): string => {
    if (currentFuel === 0) {
      return "Your fuel reserves dwindle to nothingness. As the ship's engines sputter and fall silent, you find yourself adrift in the cold vacuum of space. In a twist of cosmic fortune, a passing cargo ship detects your distress signal. A beacon of hope emerges on the horizon as the vessel alters its course to intercept your stranded spacecraft. Soon, the cargo ship pulls alongside, extending a lifeline to rescue you from the vast emptiness. They request a payment from you of 10 credits for their assistance. Help is rarely free in this line of work…";
    } else if (currentHull === 0) {
      return "The hull sustains damage beyond the point of repair. The cold vacuum of space seeps into the fragile breaches, and the vessel becomes a vulnerable shell adrift in the cosmic void. Panic grips you as vital life support systems flicker, and the comforting hum of the ship's engines fades into an ominous silence. By a twist of cosmic fate, a passing ship detects distress signals emanating from your crippled spacecraft. The rescuing vessel, a beacon of hope against the desolation of space, alters its course to intercept your dwindling lifeline. As it pulls alongside, the rescuing crew swiftly executes a daring maneuver, facilitating your transition to their functional ship. They request a payment from you of 10 credits for their assistance. Help is rarely free in this line of work…";
    } else if (currentEngine === 0) {
      return 'Your engine ceases to function beyond the scope of repair. Stranded in the vastness of the cosmos, your vessel drifts in silence, a lone beacon of technological failure against the backdrop of stars. Fortune, however, takes a turn as a passing ship detects your distress signals. Responding to the cosmic call for help, the rescuing vessel maneuvers toward your disabled spacecraft. Soon, the ship pulls alongside, extending a lifeline to rescue you from the vast emptiness. They request a payment from you of 10 credits for their assistance. Help is rarely free in this line of work…';
    } else if (currentDread === 0) {
      return 'In the isolation of deep space during a prolonged and challenging expedition, the unrelenting vastness takes its toll on your mental resilience. Gradually, the solitude becomes a haunting echo, amplifying the weight of cosmic emptiness. As the days stretch into an indistinguishable continuum, a disconcerting unraveling of composure begins. Amidst this cosmic turmoil, a passing ship, by chance or cosmic intervention, detects distress signals emanating from your deteriorating vessel. Responding to the call, the rescuing ship arrives just in time. Its crew witnesses the harrowing scene of a disoriented spacefarer, and they extend a lifeline to bring you aboard their ship. They request a payment from you of 10 credits for their assistance. Help is rarely free in this line of work…';
    } else {
